package com.rdygo.flutter_tts_improved;
 ...
 * FlutterTtsPlugin
 */
public class FlutterTtsImprovedPlugin implements MethodCallHandler {
   ...
   * Plugin registration.
   */
  private FlutterTtsImprovedPlugin(Context context, MethodChannel channel) {
  ...
  public static void registerWith(Registrar registrar) {
    final MethodChannel channel = new MethodChannel(registrar.messenger(), "flutter_tts_improved");
    channel.setMethodCallHandler(new FlutterTtsImprovedPlugin(registrar.activeContext(), channel));
  }
