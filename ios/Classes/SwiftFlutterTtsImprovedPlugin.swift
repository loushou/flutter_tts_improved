...
public class SwiftFlutterTtsImprovedPlugin: NSObject, FlutterPlugin, AVSpeechSynthesizerDelegate {
  ...
  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "flutter_tts_improved", binaryMessenger: registrar.messenger())
    let instance = SwiftFlutterTtsImprovedPlugin(channel: channel)
