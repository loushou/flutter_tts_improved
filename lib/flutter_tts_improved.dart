...
class FlutterTtsImproved {
  static const MethodChannel _channel = const MethodChannel('flutter_tts_improved');
  ...
  Future<dynamic> isLanguageAvailable(String language) => _channel.invokeMethod('isLanguageAvailable', <String, Object>{'language': language});
